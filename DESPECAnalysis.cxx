...
//     cID_Z_AoQ0  = gROOT->ProcessLine(".L ~/DESPEC_Online_Pd_v15/testpolt1.C");
  ...
  if(testingFileExist.good()==false)
    {
      std::cout<<" E> !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! "<<std::endl;
      std::cout<<" E> FRS Setup file "<<nameSetupFile<<" not found ! Please look to directory Configuration_Files/FRS/FRS_Setups/ if it exits or set proper name of experiment in config.txt"<<std::endl;
      std::cout<<" E> !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! "<<std::endl;
