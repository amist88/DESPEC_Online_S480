...
FATIMA_Detector_System::FATIMA_Detector_System(){
    ...
    read_config_variables("Configuration_Files/DESPEC_General_Setup/Detector_System_Setup_File.txt");
    he_iter = 0;
...
void FATIMA_Detector_System::load_board_channel_file(){
    ...
    ifstream file("Configuration_Files/FATIMA/FATIMA_allocation.txt");
...
//              if(tdc_board_ID==13&&TDC_ch>5 ) cout<<"active_det " <<active_det << " det_ID_TDC[tdc_board_ID][TDC_ch] " << det_ID_TDC[tdc_board_ID][TDC_ch] <<" tdc_board_ID " <<tdc_board_ID << " TDC_ch "<< TDC_ch<<" TDC_Time_raw[fired_TDC_amount] " <<TDC_Time_raw[fired_TDC_amount]<<endl;
