...
//             fGal_Pileup = 0;
        ...
        ZERO_ARRAY(fGal_Detector);
        ZERO_ARRAY(fGal_Crystal);
        ZERO_ARRAY(fGal_Event_T);
        ZERO_ARRAY(fGal_E);
        ZERO_ARRAY(fGal_T);
        ZERO_ARRAY(fGal_Pileup);
        ZERO_ARRAY(fGal_Overflow);
