...
: TGo4Parameter(name)
{
  ...
  //------------------------------------------------------------------------------//
  file.open("Configuration_Files/Germanium/GALILEO_Energy_Calibration.txt");
  if (file.fail()) {
...
//   
    ...
    */
    cout << "Fatima Time Corrections:\n";
        for (i = 0; i < 50; i++){
        cout << "Dectector " << i << "  \t TFatTDC_Chref_dT = " << TFatTDC_Chref_dT[i] <<  endl;
