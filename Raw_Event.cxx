...
void Raw_Event::set_DATA_SCI_ToF(Float_t FRS_sci_tofll2,Float_t FRS_sci_tofll3,Float_t FRS_sci_tof2,Float_t FRS_sci_tofrr2,Float_t FRS_sci_tofrr3,Float_t FRS_sci_tof3,Float_t FRS_sci_tofll5, Float_t FRS_sci_tofrr5, Float_t FRS_sci_tof5){
    sci_tofll2 = 0;
    sci_tofll3 = 0;
    sci_tof2   = 0;
    sci_tofrr2 = 0;
...
void Raw_Event::set_DATA_ID_Z_AoQ(Float_t FRS_AoQ,Float_t FRS_AoQ_corr,Float_t FRS_z,Float_t FRS_z2,Float_t FRS_z3,Float_t FRS_id_znocorr,Float_t FRS_id_z2nocorr, Float_t FRS_dEdeg,Float_t FRS_dEdegoQ){
    AoQ = 0;
    AoQ_corr = 0;
    z=0;
    z2=0;
    ...
    z2 = FRS_z2;
    z3 = FRS_z3;
    znocorr = FRS_id_znocorr;
    z2nocorr = FRS_id_z2nocorr;
    dEdeg = FRS_dEdeg;
    dEdegoQ = FRS_dEdegoQ;
...
void Raw_Event::set_DATA_FRS_SCALERS(Int_t FRS_time_in_ms, Int_t FRS_spill_count,Int_t FRS_ibin_for_s, Int_t FRS_ibin_for_100ms, Int_t FRS_ibin_for_spill,Int_t FRS_ibin_clean_for_s, Int_t FRS_ibin_clean_for_100ms,Int_t FRS_ibin_clean_for_spill, UInt_t* FRS_increase_scaler_temp){
  ...
  for (int i = 0; i < 64; i++)
      increase_scaler_temp[i] = FRS_increase_scaler_temp[i];
}
...
void Raw_Event::set_DATA_ID_MHTDC(Float_t id_mhtdc_aoq,Float_t id_mhtdc_aoq_corr, Float_t id_mhtdc_z1,Float_t id_mhtdc_z2, Float_t id_mhtdc_dEdeg,Float_t id_mhtdc_dEdegoQ, Float_t id_mhtdc_beta){
...
Float_t Raw_Event::get_FRS_znocorr(){return znocorr;}
Float_t Raw_Event::get_FRS_z2nocorr(){return z2nocorr;}
