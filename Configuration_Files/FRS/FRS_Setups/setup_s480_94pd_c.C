...
void setup_s480_94pd_c()
{
 ...
 /*
  ...
  //S4
  frs->dist_focS4   = 3310.0; //from S411
  ...
  frs->dist_S4target= 3638.0; //S480-2020March10-AIDA
...
// bfield (Tm) for new control system. (we put rho = 1)
  ...
  frs->bfield[5] = 99.999; // D6 (to S8)
   ...
   //bfield (Tm) for new control system. (we put rho = 1)
//   frs->bfield[0] = 9.3565; // FRS D1 for Xe // Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
//   frs->bfield[1] = 9.3565; // D2 for Xe // Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
//   frs->bfield[2] = 7.0287 ; // D3 for Xe // Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
//   frs->bfield[3] = 7.0287 ; // D4 for Xe // Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
//   frs->bfield[4] = 99.999; // D5 (to ESR) not used
//   frs->bfield[5] = 99.999; // D6 (to S8)
...
// TOF calibration SC21-SC81 (TAC)
  ...
  id->id_tofoff5  =267690.0;
  id->id_path5 = 271850.0; 
  id->mhtdc_length_s2s4 = 36;
  id->mhtdc_vel_a_music41[0]=  7173.56;
  id->mhtdc_vel_a_music41[1]=-13023.5;
  id->mhtdc_vel_a_music41[2]=  6869.62;
  id->mhtdc_vel_a_music41[3]=0.0;
  id->mhtdc_vel_a_music42[0]=11149.64;
  id->mhtdc_vel_a_music42[1]=-20736.89;
  id->mhtdc_vel_a_music42[2]=11031.86;
  ...
  tpc->lim_csum1[2][0] = 652.;   tpc->lim_csum1[2][1]= 790.0; //2020/feb/29
  tpc->lim_csum2[2][0] = 524.0;    tpc->lim_csum2[2][1] =  710.0;
  tpc->lim_csum3[2][0] = 764.0;    tpc->lim_csum3[2][1] = 971.0;
  tpc->lim_csum4[2][0] = 632.0;    tpc->lim_csum4[2][1] = 838.0;
 ...
 tpc->lim_csum1[3][0] = 298.;     tpc->lim_csum1[3][1]= 524.0; //2020/feb/29 Xe124
  tpc->lim_csum2[3][0] = 284.0;    tpc->lim_csum2[3][1] = 494.0;
  tpc->lim_csum3[3][0] = 3300.0;   tpc->lim_csum3[3][1] = 3300.0; // exclude this one
  tpc->lim_csum4[3][0] = 239.0;    tpc->lim_csum4[3][1] = 524.0;
  ...
  tpc->timeref_calibrun[4] = 456.2; //sc41
   tpc->lim_csum1[4][0] = 729.0;    tpc->lim_csum1[4][1] = 777.0;
  tpc->lim_csum2[4][0] = 749.0;    tpc->lim_csum2[4][1] = 817.0;
  tpc->lim_csum3[4][0] = 646.0;    tpc->lim_csum3[4][1] = 741.0;
  tpc->lim_csum4[4][0] = 677.0;    tpc->lim_csum4[4][1] = 742.0;
  ...
  tpc->lim_csum1[5][0] = 1310.0;    tpc->lim_csum1[5][1] = 1384.0;
  tpc->lim_csum2[5][0] = 1319.0;    tpc->lim_csum2[5][1] = 1383.0;
  tpc->lim_csum3[5][0] = 1340.0;    tpc->lim_csum3[5][1] = 1420.0;
  tpc->lim_csum4[5][0] = 1282.0;    tpc->lim_csum4[5][1] = 1357.0;
