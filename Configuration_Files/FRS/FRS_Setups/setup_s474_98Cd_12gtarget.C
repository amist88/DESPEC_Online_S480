...
void setup_s474_98Cd_12gtarget()
{
 ...
 /*
  ...
  frs->bfield[0] = 7.0180; // FRS D1 for Cd98 // Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[1] = 7.0180; // D2 for Cd98 // Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[2] = 5.2813; // D3 for Cd98 // Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[3] = 5.2813; // D4 for Cd98 // Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
...
// TOF calibration SC21-SC81 (TAC)
  ...
  id->mhtdc_vel_a_music41[0]=  7173.56; //  MUSIC41 velocity corr.
  id->mhtdc_vel_a_music41[1]= -13023.5; // -17462*1.096
  id->mhtdc_vel_a_music41[2]= 6869.62; //  7682 *1.096
  id->mhtdc_vel_a_music41[3]=0.0;
  id->mhtdc_vel_a_music42[0]=11149.64 ; // MUSIC42 like MUSIC41 (too high)
  id->mhtdc_vel_a_music42[1]=-20736.89 ;
  id->mhtdc_vel_a_music42[2]=-20736.89 ;
  ...
  */
  ...
  id->ID_Z_AoverQ[0][0][0]=2.05      ; id->ID_Z_AoverQ[0][0][1]=48.;
  id->ID_Z_AoverQ[0][1][0]=2.05      ; id->ID_Z_AoverQ[0][1][1]=49.;
  id->ID_Z_AoverQ[0][2][0]=2.03      ; id->ID_Z_AoverQ[0][2][1]=49.;
  id->ID_Z_AoverQ[0][3][0]=2.03      ; id->ID_Z_AoverQ[0][3][1]=48. ;
  id->ID_Z_AoverQ[0][4][0]=2.05      ; id->ID_Z_AoverQ[0][4][1]=48.;
