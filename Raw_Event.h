...
private:
    ...
    Float_t sci_tofrr5; // set_DATA_SCI_ToF
	...
	Float_t znocorr;    // set_DATA_ID_Z_AoQ
    Float_t z2nocorr;    // set_DATA_ID_Z_AoQ
...
public:
	...
	void set_DATA_SCI_ToF(Float_t,Float_t,Float_t,Float_t,Float_t,Float_t,Float_t,Float_t,Float_t);
	...
	void set_DATA_ID_Z_AoQ(Float_t,Float_t,Float_t,Float_t,Float_t,Float_t,Float_t,Float_t,Float_t);
    ...
    void set_DATA_ID_MHTDC(Float_t,Float_t,Float_t,Float_t,Float_t,Float_t,Float_t);    
	// FRS STUFF //
...
// 						  std::vector<double> &VME_TDC_Data,std::vector<double> &VME_TDC_Channels);
	...
	Float_t get_FRS_z2();
	Float_t get_FRS_z3();
    Float_t get_FRS_znocorr();
    Float_t get_FRS_z2nocorr();
...
// 	PLASTIC_DataStruct* PassPLASTIC();
	...
	//temporary GALILEO getters
        ...
        ULong64_t   get_GALILEO_Event_T(int);
