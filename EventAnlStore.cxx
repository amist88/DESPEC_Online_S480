...
void EventAnlStore::Clear(Option_t *t)
{
    ...
    ZERO_ARRAY(pFRS_Music_dE_corr);
    ZERO_ARRAY(pFRS_Music_E1);
    ZERO_ARRAY(pFRS_Music_E2);
    ZERO_ARRAY(pFRS_Music_T1);
    ZERO_ARRAY(pFRS_Music_T2);
   ...
   // for(int i=0; i< 50; i++){
    ...
    ZERO_ARRAY(pGal_Event_T);
    ZERO_ARRAY(pGal_T);
    ZERO_ARRAY(pGal_E);
    ZERO_ARRAY(pGal_E_Raw);
    ZERO_ARRAY(pGal_EAddback);
    ZERO_ARRAY(pGalPileUp);
    ZERO_ARRAY(pGalOverFlow);
